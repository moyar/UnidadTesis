					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="{{URL::action('RespuestaController@editd',$comment->id_respuesta,$topico->id_topico)}}" class="btn btn-xs btn-info"><span class="glyphicon glyphicon-pencil"></span> Editar</a>

								<a href="" data-target="#modalR-delete-{{$comment->id_respuesta}}" data-toggle="modal"class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash"></span> Eliminar</a>
								</center>
							</td>
						</tr>
