        ...
        <table class="table table-striped table-bordered table-condensed table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{URL::action('ComentarioController@edit',$comment->id,$estudiante->id_user)}}" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-pencil"></span></a>
						...
						@include('administracion.estudiante.modalC')
						@endforeach
					</tbody>
				</table>
			</div>
